  ...
  <div class="hello">
    ...
    <form class="form-inline"
      ...
      <input type="text"
             ...
             name=word>
      <button type="submit"
              class="btn  btn-outline-dark">搜索</button>
    </form>
    <h3>视频</h3>
    <ul>
      <li><a href="https://www.iqiyi.com/"
           target="_blank"
           rel="noopener">爱奇艺</a></li>
      <li><a href="https://v.qq.com/"
           target="_blank"
           rel="noopener">腾讯</a></li>
      <li><a href="https://www.youku.com/"
           target="_blank"
           rel="noopener">优酷网</a></li>
      <li><a href="https://www.bilibili.com/"
           target="_blank"
           rel="noopener">bilibili</a></li>
    </ul>
    <h3>工具</h3>
    <ul>
      <li><a href="https://cloud.tencent.com/"
           target="_blank"
           rel="noopener">腾讯云</a></li>
      <li><a href="https://www.csdn.net/"
           target="_blank"
           rel="noopener">CSDN</a></li>
      <li><a href="https://www.aliyun.com/"
           target="_blank"
           rel="noopener">阿里云</a></li>
      <li><a href="https://github.com/"
           target="_blank"
           rel="noopener">GitHub</a></li>
      <li><a href="https://www.bootcss.com/"
           target="_blank"
           rel="noopener">Bootstrap中文网</a></li>
    </ul>
    <h3>Ecosystem</h3>
    <ul>
